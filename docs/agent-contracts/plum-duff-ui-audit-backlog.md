...
| P1 | All major routes at narrow viewport | No single regression suite asserts absence of page-level horizontal overflow | Add a route matrix Playwright test at desktop/tablet/mobile widths | Layout, WCAG reflow |
