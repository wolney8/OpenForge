...
|---|---|---|---|
| `CALCULATOR-WORKSPACE-001` | Feature / Fund Manager standalone calculator workspace | `IN PROGRESS locally; user acceptance PENDING RECHECK`: Standard, Multi-Lay, Each Way / Extra Place and Sequential Lay are implemented reference-only families. Sequential Lay's Standard/Lock In recurrence, directional penny rounding, per-leg commission, dynamic leg lifecycle and outcomes are pinned by `sequential-lay-calculation-v1`; current source output supersedes older approximate narrative pennies. Early Payout / 2UP, Multiples / Accumulator, Dutching, Odds / Probability and Blackjack remain queued. The calculator-to-ledger draft bridge is separate later scope | Calculator workspace workflow/fixtures; [#35](https://github.com/wolney8/OpenForge/issues/35), contracts/fixtures [#37](https://github.com/wolney8/OpenForge/issues/37), advanced catalogue [#38](https://github.com/wolney8/OpenForge/issues/38), Sequential Lay [#39](https://github.com/wolney8/OpenForge/issues/39), later bridge [#36](https://github.com/wolney8/OpenForge/issues/36) |
