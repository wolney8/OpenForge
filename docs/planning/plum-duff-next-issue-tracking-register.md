...
| `NOTIFICATION-LAYOUT-001` | Visual fix / keep Notification History Search, Type, Status, and actions inside allocated fields with unobscured focus | `COMPLETE locally` at `f2db33a`; reproduced intrinsic-width overflow, corrected with shared toolbar constraints, and focused layout tests pass; #100 stays open for Will acceptance | Supplied screenshot and acceptance criteria; [#100](https://github.com/wolney8/OpenForge/issues/100), related bounded review [#92](https://github.com/wolney8/OpenForge/issues/92) |
