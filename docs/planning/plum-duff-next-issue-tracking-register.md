...
|---|---|---|---|
| `CALCULATOR-WORKSPACE-001` | Feature / Fund Manager standalone calculator workspace | `IN PROGRESS locally; user acceptance PENDING RECHECK`: Standard, Multi-Lay, Extra Place / Each Way, Sequential Lay and Early Payout / 2UP are implemented reference-only families. Extra Place is the family default and named modes use the canonical segmented control. Early Payout covers Exchange Lay and 2-Way Dutch, explicit trigger lock-in, maximum payout, actual stake and part backs; its full-width Reference/Outcomes peer sections remain stable during live slider previews, with readiness and local-reset controls. Persisted tracker lifecycle vocabulary remains separate draft scope. Multiples / Accumulator, Dutching, Odds / Probability and Blackjack remain queued. The calculator-to-ledger draft bridge is separate later scope | Calculator workspace workflow/fixtures; [#35](https://github.com/wolney8/OpenForge/issues/35), contracts/fixtures [#37](https://github.com/wolney8/OpenForge/issues/37), advanced catalogue [#38](https://github.com/wolney8/OpenForge/issues/38), Sequential Lay [#39](https://github.com/wolney8/OpenForge/issues/39), later bridge [#36](https://github.com/wolney8/OpenForge/issues/36) |
