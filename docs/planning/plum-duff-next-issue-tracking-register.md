...
| `CALCULATOR-VERIFICATION-001` | Audit / independently verify every exposed standalone calculator family and significant mode | `EXTENDED AUDIT — REVIEW PENDING`: 85 supported configuration fixtures pass (60-cell Standard cross-product plus 25 existing non-Standard cases); this remains finite fixture evidence, not proof of every numeric input. Current Outplayed source plus independent equations govern Bonus Lock-In Normal/SNR for both triggers and all five exposed strategies. Ten required Bonus Free Bet SR cells remain blocked; eight external comparisons remain explicitly unverified. The editable manual comparison worksheet preserves blank third-party observations for Will. | [Issue #113 audit](../audits/issue-113-independent-calculator-verification-2026-09-10.md); [manual comparison](../audits/calculator-manual-comparison.md); fixtures `calculator-independent-verification-v1` and `bonus-lock-in-reference-v1`; [#113](https://github.com/wolney8/OpenForge/issues/113), [#105](https://github.com/wolney8/OpenForge/issues/105), [#37](https://github.com/wolney8/OpenForge/issues/37) |
...
| `CALCULATOR-WORKSPACE-001` | Feature / Fund Manager standalone calculator workspace | `CODE-VERIFIED — USER RECHECK PENDING`: Standard uses exact Bet Type Normal/SNR/SR and Simple/Advanced presentation controls. Bonus Lock-In exposes governed Normal/SNR × Loses/Wins and shared Standard/Underlay/Overlay/Custom/Part Lay presentation; SR remains a visible tracked blocker rather than an exposed option. Profit Boost retains source-specific odds, return/profit and accepted-odds precedence. | Calculator workspace workflow/fixtures; [manual comparison](../audits/calculator-manual-comparison.md); [#35](https://github.com/wolney8/OpenForge/issues/35), contracts/fixtures [#37](https://github.com/wolney8/OpenForge/issues/37), later bridge [#36](https://github.com/wolney8/OpenForge/issues/36) |
