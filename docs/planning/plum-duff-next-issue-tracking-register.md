...
| PQA-J15 / #62 | Separate application-owned OAuth recovery from provider interaction | ENGINEERING SIDE PASS / OWNER INTERACTION REQUIRED: configured Google initiation, state/callback/denial/expiry/recovery pass; fresh Google UI remains external |
