...
| `PD-FIX-BLACKJACK-COMPOSITION-001` | UI correction / compact Blackjack live-use composition | `CODE-VERIFIED — USER RECHECK PENDING`: Last Hand uses the shared animated full-width disclosure for click/automatic transitions without a side track. UP-CARD and every selected CARD N expose the overlaid shared centred undo control. Money-mode history exposes committed STAKED without adding Simulation finance; stake-known rounds offer Rebet, Rebet & Deal Again and Double & Deal Again. | [#40](https://github.com/wolney8/OpenForge/issues/40), bridge [#36](https://github.com/wolney8/OpenForge/issues/36), consistency [#92](https://github.com/wolney8/OpenForge/issues/92), workspace [#35](https://github.com/wolney8/OpenForge/issues/35) |
