...
| `CALCULATOR-VERIFICATION-001` | Audit / independently verify every exposed standalone calculator family and significant mode | `CORRECTED AUDIT — REVIEW PENDING`: 29 representative fixtures match their governed contracts; this is not proof of every strategy/input cross-product. Overlay canonicalises rounded signed zero. Current Outplayed source plus independent equations govern Bonus Lock-In Normal backing for both triggers and Free Bet SNR Standard/Part Lay. Free Bet SR and SNR advanced capital-target combinations remain unsupported; eight external comparisons remain explicitly unverified. | [Issue #113 audit](../audits/issue-113-independent-calculator-verification-2026-09-10.md); fixtures `calculator-independent-verification-v1` and `bonus-lock-in-reference-v1`; [#113](https://github.com/wolney8/OpenForge/issues/113), [#105](https://github.com/wolney8/OpenForge/issues/105), [#37](https://github.com/wolney8/OpenForge/issues/37) |
| `CALCULATOR-BRIDGE-001` | Feature / immutable calculator or completed-session source into reviewed Profile ledger activity | `CORRECTED LOCALLY — WILL ACCEPTANCE PENDING`: the existing bridge reuses canonical destination classifications and Account IDs, retains source state, closes successful reviews to a linked calculator receipt, distinguishes retry from deliberate exploratory intent, and leaves partial failures editable. Normal Bonus Lock-In for either trigger preserves its selected governed lay stake. Bonus Lock-In Free Bet backing is calculator-supported but conversion-blocked because Sportsbook has no backing-basis field. Existing Multi-Lay, Extra Place / Each Way and completed Blackjack adapters remain unchanged. Sequential Lay, Early Payout / 2UP, Multiples and Dutching remain losslessly blocked; Odds / Probability and Blackjack Simulation remain utilities. | [Authoritative bridge matrix](../workflows/calculator-workspace-ledger-bridge-workflow-contract.md#authoritative-conversion-matrix); [#36](https://github.com/wolney8/OpenForge/issues/36), reused multi-Profile workflow [#77](https://github.com/wolney8/OpenForge/issues/77) |
| `CALCULATOR-WORKSPACE-001` | Feature / Fund Manager standalone calculator workspace | `CODE-VERIFIED — USER RECHECK PENDING`: core family coverage remains locally proven. Bonus Lock-In now presents one offer-aware Standard/Advanced system for governed Normal backing and exposes SNR Standard/Part Lay without implying SNR advanced or SR support. Profit Boost presents source-specific odds, return/profit and accepted-odds precedence before lay completion. The shared calculator presentation and family navigation remain unchanged. | Calculator workspace workflow/fixtures; [#35](https://github.com/wolney8/OpenForge/issues/35), contracts/fixtures [#37](https://github.com/wolney8/OpenForge/issues/37), later bridge [#36](https://github.com/wolney8/OpenForge/issues/36) |
