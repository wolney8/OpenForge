...
| `FINANCIAL-MOTION-001` | Presentation / brief shared digit roll for initial resolved and changed read-only signed-money values, directed by destination sign | `CAPTURED`; existing component is delta-directed and suppresses initial motion, so implementation and all rollout coverage remain pending verification; editable fields and file/print exports stay static | [Presentation contract](../contracts/financial-value-presentation-contract.md); [fixture spec](../fixture-specs/financial-value-presentation-fixture-spec.md); [#105](https://github.com/wolney8/OpenForge/issues/105) |
