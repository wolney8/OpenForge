...
| --- | ---: | --- |
| Assessments reviewed | 51 / 87 (59%) | A documented defect can complete an assessment |
...
| Profile and combined financial reporting | Passed for scoped arithmetic/correction | Interactive chart drilldown and balance-observation workflows remain planned |
