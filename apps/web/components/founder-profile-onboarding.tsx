        ...
        <LedgerEditorTabPanel activeTabId={stage} tabId="review"><section className="analytics-tab-panel stack" data-guided-field="create-profile">
          ...
          <div className="stat-grid founder-onboarding-review-grid">
            ...
            {setupPath === "fresh" ? <>
              ...
              <FinancialValueReplayGroup><article className="stat-card"><span className="eyebrow">Opening Account Cash</span><strong><FinancialValue value={selectedCash} /></strong><span>Starting bankroll: <FinancialValue value={parseAmount(profile.starting_bankroll)} /></span></article></FinancialValueReplayGroup>
            </> : null}
          </div>
