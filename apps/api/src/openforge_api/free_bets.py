...
class FreeBetPayload(BaseModel):
    ...
    source_award_group_id: str = Field(default="", max_length=64)
    source_award_split_index: int = Field(default=0, ge=0)
    source_award_split_total: int = Field(default=0, ge=0)
    source_award_expected_value: str = Field(default="", max_length=40)
    source_award_variance_reason: str = Field(default="", max_length=500)
