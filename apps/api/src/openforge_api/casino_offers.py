...
class CasinoOfferPayload(BaseModel):
    ...
    wagering_base: str = Field(default="", max_length=80)
    custom_wager_base: str = Field(default="", max_length=40)
    wagering_completed: str = Field(default="", max_length=40)
    rtp_percent: str = Field(default="", max_length=40)
    reward_type: str = Field(default="", max_length=80)
    reward_wager_multiplier: str = Field(default="", max_length=40)
    reward_wager_target: str = Field(default="", max_length=40)
    reward_required_spins: str = Field(default="", max_length=40)
    reward_wagering_completed: str = Field(default="", max_length=40)
    reward_rtp_percent: str = Field(default="", max_length=40)
    expected_reward_cash_value: str = Field(default="", max_length=40)
    qualifying_expected_loss: str = Field(default="", max_length=40)
    reward_expected_loss: str = Field(default="", max_length=40)
    other_expected_costs: str = Field(default="", max_length=40)
    campaign_ev: str = Field(default="", max_length=40)
    own_cash_committed: str = Field(default="", max_length=40)
    cash_returned: str = Field(default="", max_length=40)
    settlement_other_costs: str = Field(default="", max_length=40)
    status: StatusValue
    result: ResultValue
